...
public class ImpostoResourceIntTest {
    ...
    private static final Long DEFAULT_IV_TOT_TRIB = 1L;
    private static final Long UPDATED_IV_TOT_TRIB = 2L;

    private static final Long DEFAULT_I_ICMS = 1L;
    private static final Long UPDATED_I_ICMS = 2L;

    private static final Long DEFAULT_I_IPI = 1L;
    private static final Long UPDATED_I_IPI = 2L;

    private static final Long DEFAULT_I_II = 1L;
    private static final Long UPDATED_I_II = 2L;

    private static final Long DEFAULT_I_ISSQN = 1L;
    private static final Long UPDATED_I_ISSQN = 2L;

    private static final Long DEFAULT_I_PIS = 1L;
    private static final Long UPDATED_I_PIS = 2L;

    private static final Long DEFAULT_I_PISST = 1L;
    private static final Long UPDATED_I_PISST = 2L;

    private static final Long DEFAULT_I_COFINS = 1L;
    private static final Long UPDATED_I_COFINS = 2L;

    private static final Long DEFAULT_I_COFINSST = 1L;
    private static final Long UPDATED_I_COFINSST = 2L;

    private static final Long DEFAULT_I_ICMSUF_DEST = 1L;
    private static final Long UPDATED_I_ICMSUF_DEST = 2L;
    ...
    public void setup() {
        ...
        final ImpostoResource impostoResource = new ImpostoResource(impostoRepository);
    ...
    public void getAllImpostos() throws Exception {
        ...
        restImpostoMockMvc.perform(get("/api/impostos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ivTotTrib").value(hasItem(DEFAULT_IV_TOT_TRIB.intValue())))
            .andExpect(jsonPath("$.[*].iICMS").value(hasItem(DEFAULT_I_ICMS.intValue())))
            .andExpect(jsonPath("$.[*].iIPI").value(hasItem(DEFAULT_I_IPI.intValue())))
            .andExpect(jsonPath("$.[*].iII").value(hasItem(DEFAULT_I_II.intValue())))
            .andExpect(jsonPath("$.[*].iISSQN").value(hasItem(DEFAULT_I_ISSQN.intValue())))
            .andExpect(jsonPath("$.[*].iPIS").value(hasItem(DEFAULT_I_PIS.intValue())))
            .andExpect(jsonPath("$.[*].iPISST").value(hasItem(DEFAULT_I_PISST.intValue())))
            .andExpect(jsonPath("$.[*].iCOFINS").value(hasItem(DEFAULT_I_COFINS.intValue())))
            .andExpect(jsonPath("$.[*].iCOFINSST").value(hasItem(DEFAULT_I_COFINSST.intValue())))
            .andExpect(jsonPath("$.[*].iICMSUFDest").value(hasItem(DEFAULT_I_ICMSUF_DEST.intValue())))
    ...
    public void getImposto() throws Exception {
        ...
        restImpostoMockMvc.perform(get("/api/impostos/{id}", imposto.getId()))
            ...
            .andExpect(jsonPath("$.ivTotTrib").value(DEFAULT_IV_TOT_TRIB.intValue()))
            .andExpect(jsonPath("$.iICMS").value(DEFAULT_I_ICMS.intValue()))
            .andExpect(jsonPath("$.iIPI").value(DEFAULT_I_IPI.intValue()))
            .andExpect(jsonPath("$.iII").value(DEFAULT_I_II.intValue()))
            .andExpect(jsonPath("$.iISSQN").value(DEFAULT_I_ISSQN.intValue()))
            .andExpect(jsonPath("$.iPIS").value(DEFAULT_I_PIS.intValue()))
            .andExpect(jsonPath("$.iPISST").value(DEFAULT_I_PISST.intValue()))
            .andExpect(jsonPath("$.iCOFINS").value(DEFAULT_I_COFINS.intValue()))
            .andExpect(jsonPath("$.iCOFINSST").value(DEFAULT_I_COFINSST.intValue()))
            .andExpect(jsonPath("$.iICMSUFDest").value(DEFAULT_I_ICMSUF_DEST.intValue()))
